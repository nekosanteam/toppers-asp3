 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: bcm283x.h 1838 2016-09-24 00:00:00Z azo $
 */
...
#else
#error Either TOPPERS_BCM283X must be defined.
#endif
...
#define IO2_SIZE		0x00100000		/* 1MB */
#endif

/*
 * 割り込みの数
 */
#define BCM283X_TNUM_INHNO		UINT_C(128)
